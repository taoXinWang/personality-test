      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8">
          ...
          <div className="space-y-6">
            {dimensionScores.map((score) => {
              ...
              const poleName = score.pole === 'high' ? dim.highPole.name.en : dim.lowPole.name.en;
              const strengthLabel = score.preferenceStrength === 'strong' ? 'Strong' :
                  ...
                  <div className="flex justify-between items-center mb-2">
                    <div>
                      ...
                      <span className="text-gray-600 dark:text-gray-400 ml-2">
                        {poleName} ({strengthLabel} preference)
                      </span>
                    </div>
        ...
        <div className="bg-blue-600 text-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="mb-6 opacity-90">
            Invite your friends to discover their personality type!
          </p>
